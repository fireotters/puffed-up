...
namespace ExtensionsFunctions
{
    public static class Rigidbody_Extensions
    {
        ...
        /// correctly.
        /// </summary>
        public static float2 AccelerateTo2D(this Rigidbody2D rb, Vector2 targetVelocity, float inverseMass,
        ...
        /// Makes the rigidbody accelerate to targetVelocity with maxAcceleration acceleration.
        /// </summary>
        public static float3 AccelerateTo(this Rigidbody rb, Vector3 targetVelocity,
            float maxAcceleration = float.PositiveInfinity)
        {
            var deltaVelocity = targetVelocity - rb.velocity;
            var acceleration = deltaVelocity / Time.deltaTime;
